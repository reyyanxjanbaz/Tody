> ⚠️ **Archived.** This React Native app is no longer developed or maintained — the
> web PWA at the repo root is the flagship client. Kept here for reference; the
> logic it once shared with the web app has since diverged (see root `README.md`).
